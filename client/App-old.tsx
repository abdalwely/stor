...
import PendingApproval from "./pages/merchant/PendingApproval\";;val\";oval\";proval\";val\";al";
...
import ComprehensiveStorefront from "./pages/store/ComprehensiveStorefront\";;ont\";nt";
